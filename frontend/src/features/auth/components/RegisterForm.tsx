...
import { postAuthRedirectPath, readReturnTo, routes } from "../../../app/router/routes";
...
export function RegisterForm() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      window.location.assign(role === "Partner" ? routes.profile : postAuthRedirectPath(loginResult.user.role, readReturnTo()));
    } catch (error) {
